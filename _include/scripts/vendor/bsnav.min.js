!function (n) {
    ...
    var a = {
        initialize: function () {
            ...
            if (n(".bsnav-sticky")[0]) {
                var s = n(".bsnav-sticky").outerHeight(), i = n(window).scrollTop();
                a(n(".bsnav-sticky"), s, i), n(window).on("scroll", function () {
                    i = n(window).scrollTop(), a(n(".bsnav-sticky"), s, i)
                })
            }
        }, scrollspy: function () {
            var a = n(".bsnav-scrollspy"), s = a.outerHeight(), i = [];
            if (a.length) {
                ...
                function e() {
                    if (!a.hasClass("spying")) {
                        ...
                        i.map(function (i, o) {
                            var t = n("#" + i).offset().top - s, l = t + n("#" + i).outerHeight();
                ...
                n(window).scroll(function () {
                    ...
                    a.find(".nav-item").removeClass("active"), n(this).parent().addClass("active"), n("html,body").animate({scrollTop: n("#" + e).offset().top - s}, 800, function () {
